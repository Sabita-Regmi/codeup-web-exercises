...
function createBook(title,firstName,lastName){
   ...
   books. push(createBook("Pride and Prejudice", "Jane", "Austen"));
    books. push(createBook("David Copperfield","Charles", "Dickens"));
    books. push(createBook("Moby-Dick" , "Herman", "Melville"));


    function showBookInfo(book) {
        console.log("Title: " + book.title);
        console.log("firstname: " + book.firstName);
        console.log("lastName: "+ book.lastName);
    }
console.log(books);
})();
